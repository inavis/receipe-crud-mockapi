...
function AfterLoad({receipelist}){
  ...
  const buttonstyle = { background: "black", color: "white", border: "2px solid white" };
    ...
    let {id, name, picturelink, ingredients, receipe, videolink, notes,
         ...
         receipe=receipe.join(".")
        notes = notes.length>1?notes.join("."):["NA"]
  ...
  const {handleSubmit,values,handleChange,handleBlur,touched,errors} = useFormik({
    initialValues:{ name:name, picturelink:picturelink, ingredients:ingredients, receipe:receipe, 
        videolink:videolink, notes:notes, preptime:preptime, cooktime:cooktime, soakingtime:soakingtime, fermentationtime:fermentationtime, totaltime:totaltime,
         course:course, cuisine:cuisine, servings:servings, calories:calories,carbohydrates:carbohydrates, protein:protein, fat:fat, sodium:sodium, 
         potassium:potassium, fiber:fiber, sugar:sugar, calcium:calcium, iron:iron, vitamina:vitamina, vitaminc:vitaminc},
